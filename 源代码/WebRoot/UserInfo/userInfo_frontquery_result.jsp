  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_userMemo_edit" class="col-md-3 text-right">个人说明:</label>
		  	 <div class="col-md-9">
			    <textarea id="userInfo_userMemo_edit" name="userInfo.userMemo" rows="8" class="form-control" placeholder="请输入个人说明"></textarea>
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (userInfo, response, status) {
			if (userInfo) {
				...
				$("#userInfo_userMemo_edit").val(userInfo.userMemo);
